...
.subckt vending_machine_18105070 vdd gnd change[0] change[1] clk in[0] in[1]
+ out rst 

X_60_ in[1] vdd gnd _16_ _6_ _17_ NAND3X1
X_57_ vdd gnd rst _13_ n_state[2] _14_ NOR3X1
X_95_ vdd gnd _42_ out BUFX2
XSFILL8080x2100 vdd gnd FILL
X_54_ gnd vdd n_state[1] _11_ _12_ _9_ OAI21X1
X_92_ vdd _0_[0] gnd n_state[2] clk DFFPOSX1
X_89_ vdd _1_ gnd _42_ clk DFFPOSX1
X_51_ vdd _8_ gnd _9_ rst NOR2X1
X_48_ gnd vdd n_state[2] n_state[1] _6_ _5_ OAI21X1
X_86_ gnd vdd _14_ _39_ _40_ _22_ 
+ _37_
+ AOI22X1
X_45_ vdd _3_ gnd in[0] _2_ NAND2X1
X_83_ gnd vdd in[0] _2_ _37_ _36_ OAI21X1
XSFILL7760x2100 vdd gnd FILL
XSFILL7280x6100 vdd gnd FILL
XSFILL7600x100 vdd gnd FILL
XSFILL3600x2100 vdd gnd FILL
XSFILL8400x4100 vdd gnd FILL
X_80_ _42_ _34_ vdd gnd INVX1
X_77_ _31_ vdd gnd _14_ _23_ _32_ NAND3X1
X_74_ _25_ vdd gnd _21_ _29_ _43_[0] NAND3X1
XSFILL3120x4100 vdd gnd FILL
X_71_ gnd vdd _5_ n_state[1] _27_ _10_ AOI21X1
X_68_ gnd vdd rst _19_ _24_ in[1] OAI21X1
XSFILL7920x100 vdd gnd FILL
X_65_ _20_ vdd gnd in[1] _14_ _21_ NAND3X1
XSFILL3120x2100 vdd gnd FILL
X_62_ _15_ vdd gnd _17_ _18_ _0_[1] NAND3X1
X_59_ in[0] _16_ vdd gnd INVX1
XSFILL7760x100 vdd gnd FILL
XSFILL2800x4100 vdd gnd FILL
XSFILL7600x6100 vdd gnd FILL
X_56_ n_state[1] _13_ vdd gnd INVX1
X_94_ vdd gnd _41_[1] change[1] BUFX2
XSFILL3440x6100 vdd gnd FILL
XSFILL3120x100 vdd gnd FILL
X_53_ _10_ _11_ vdd gnd INVX1
X_91_ vdd _43_[1] gnd _41_[1] clk DFFPOSX1
X_88_ vdd _0_[1] gnd n_state[1] clk DFFPOSX1
XSFILL3600x100 vdd gnd FILL
X_50_ n_state[2] _8_ vdd gnd INVX1
X_47_ rst _5_ vdd gnd INVX1
X_85_ _3_ vdd gnd _36_ _38_ _39_ NAND3X1
X_44_ in[1] _2_ vdd gnd INVX1
X_82_ vdd _36_ gnd in[1] _42_ NAND2X1
X_79_ gnd vdd _30_ _33_ _43_[1] _32_ OAI21X1
XSFILL3440x100 vdd gnd FILL
XSFILL7600x2100 vdd gnd FILL
XSFILL7120x6100 vdd gnd FILL
X_76_ gnd vdd rst _30_ _31_ in[1] OAI21X1
XSFILL7440x100 vdd gnd FILL
XSFILL3440x2100 vdd gnd FILL
XSFILL8240x4100 vdd gnd FILL
X_73_ gnd vdd _41_[0] _26_ _29_ _27_ 
+ _28_
+ AOI22X1
XSFILL3280x100 vdd gnd FILL
X_70_ vdd gnd _8_ _13_ rst _26_ NOR3X1
X_67_ in[0] in[1] gnd vdd _23_ XNOR2X1
XSFILL3760x6100 vdd gnd FILL
X_64_ gnd vdd rst _19_ _20_ in[0] OAI21X1
X_61_ gnd vdd n_state[1] _4_ _18_ _9_ OAI21X1
XSFILL7920x4100 vdd gnd FILL
X_58_ vdd _15_ gnd _11_ _14_ NAND2X1
X_55_ vdd _0_[0] gnd _12_ _7_ NAND2X1
X_93_ vdd gnd _41_[0] change[0] BUFX2
XFILL9520x6100 vdd gnd FILL
X_52_ vdd _10_ gnd in[0] in[1] NAND2X1
X_90_ vdd _43_[0] gnd _41_[0] clk DFFPOSX1
XSFILL2640x4100 vdd gnd FILL
XSFILL7920x2100 vdd gnd FILL
XSFILL7440x6100 vdd gnd FILL
X_49_ vdd _7_ gnd _6_ _4_ NAND2X1
X_87_ gnd vdd _34_ _35_ _1_ _40_ OAI21X1
X_46_ _3_ _4_ vdd gnd INVX1
XSFILL3280x6100 vdd gnd FILL
X_84_ vdd _38_ gnd in[1] _16_ NAND2X1
X_81_ gnd vdd _11_ _6_ _35_ _26_ AOI21X1
X_78_ gnd vdd _5_ _27_ _33_ _26_ AOI21X1
XFILL9520x100 vdd gnd FILL
X_75_ _41_[1] _30_ vdd gnd INVX1
X_72_ vdd gnd rst _19_ n_state[2] _28_ NOR3X1
X_69_ _24_ vdd gnd _22_ _23_ _25_ NAND3X1
X_66_ vdd gnd n_state[1] _8_ rst _22_ NOR3X1
XSFILL3280x2100 vdd gnd FILL
XSFILL8080x4100 vdd gnd FILL
X_63_ _41_[0] _19_ vdd gnd INVX1
XSFILL2960x4100 vdd gnd FILL
XSFILL3600x6100 vdd gnd FILL
